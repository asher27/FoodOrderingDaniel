...
CREATE POLICY "All operations to authenticated users" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "All operations to authenticated users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Enable delete access for on authenticated users" ON "public"."products" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable update access for on authenticated users" ON "public"."products" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
